...
let chart1data = [], chart2data = [], chart3data = [], chart4data = [], chart5data = [], chart6data = [], chart7data = [];
let sliderVal;
let numPoints;
...
document.addEventListener('DOMContentLoaded', function () {
  ...
  let chartCanvas = [chartCanvas1, chartCanvas2, chartCanvas3, chartCanvas4, chartCanvas5, chartCanvas6, chartCanvas7];
  generateChartData(0);
